...
def build_agent_system_prompt(skill):
    ...
    return (
        ...
        "5. У ФІНАЛЬНІЙ відповіді НЕ вставляй посилань для завантаження й НЕ пиши шляхів до "
        "файлів (ні markdown-посилань `[..](..)`, ні `sandbox:/...`, ні відносних шляхів). "
        "Ти НЕ знаєш реального URL — платформа сама додасть робоче посилання. Просто назви "
        "файл словами (напр. «Готово: файл Оцінка.xlsx створено»).\n"
        "6. Лише КОЛИ файл реально створено — дай коротку фінальну відповідь користувачу "
        "БЕЗ блоку коду.\n\n"
        f"========== SKILL.md ==========\n{instructions}\n\n"
        f"========== Файли навички ==========\n{tree}\n"
        f"{bundle}\n"
